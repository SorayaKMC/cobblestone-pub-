...
DEFAULT_SUPPLIERS = [
    # Drinks (23% VAT)
    ("Diageo", 23, "Drinks – Beer & Cider"),
    ("Four Provinces", 23, "Drinks – Beer & Cider"),
    ("9 White Deer Brewery", 23, "Drinks – Beer & Cider"),
    ("JC Kenny", 23, "Drinks – Beer & Cider"),
    ("Tindal Wines", 23, "Drinks – Wine"),
    ("Bulmers", 23, "Drinks – Beer & Cider"),
    ("Fierce Mild", 23, "Drinks – Beer & Cider"),
    ("Noreast", 23, "Drinks – Beer & Cider"),
    ("Jameson", 23, "Drinks – Spirits"),
    # Food & grocery (mixed VAT)
    ("BWG", 13.5, "Food & Consumables"),
    ("BWG Foods", 13.5, "Food & Consumables"),
    ("Musgrave", 13.5, "Food & Consumables"),
    ("Fresh", 13.5, "Food & Consumables"),
    ("Lidl", 13.5, "Food & Consumables"),
    ("Tesco", 13.5, "Food & Consumables"),
    ("Gala", 13.5, "Food & Consumables"),
    ("Kitchen Sink", 13.5, "Food & Consumables"),
    ("ANTA Food", 13.5, "Food & Consumables"),
    ("Newtown Coffee", 13.5, "Food & Consumables"),
    # Services & supplies (23% VAT)
    ("JS Cleaning", 23, "Cleaning"),
    ("Screw Fix", 23, "Supplies"),
...
# Map old category names → new consolidated names (applied as a DB migration on startup)
CATEGORY_REMAP = {
    "Drinks - Beer":          "Drinks – Beer & Cider",
    "Drinks - Cider":         "Drinks – Beer & Cider",
    "Drinks - Spirits/Beer":  "Drinks – Beer & Cider",
    "Drinks":                 "Drinks – Beer & Cider",
    "Drinks - Wine":          "Drinks – Wine",
    "Drinks - Spirits":       "Drinks – Spirits",
    "Food":                   "Food & Consumables",
    "Food - Coffee":          "Food & Consumables",
    "Supplies - Hardware":    "Supplies",
    "Merchandise/Supplies":   "Supplies",
    "Services - Security":    "Services",
    "Software/Subscriptions": "Software & Subscriptions",
    "Utilities - Electricity":"Utilities – Electricity",
    "Utilities - Gas":        "Utilities – Gas",
    "Utilities - Telecoms":   "Utilities – Telecoms",
