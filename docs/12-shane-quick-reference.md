...
## Subscribe to the bookings calendar in your own Google Calendar

So your gigs show up on your phone:

1. In your own Google Calendar, left sidebar → **Other calendars**
   → **+** → **Subscribe to calendar**
2. Enter `bookings@cobblestonepub.ie`
3. Save → all upcoming Backroom events now show in your calendar

The colors on that calendar mean:
- 🟢 Green: form-backed gig (band has submitted info)
- 🟡 Yellow: calendar-only (we've got the date but no info yet)
- 🟣 Purple: upstairs / workshop event (not in the Backroom)
- ⚫ Grey: bar / non-Backroom (not your gig)

---

## When something looks wrong, call us

| Issue | Who |
|---|---|
| Booking detail looks wrong (wrong time, wrong band) | Tomás (he confirms the bookings) |
| The app errors out / a button doesn't work | Soraya (she manages the system) |
| Band hasn't responded to you about sound check | Tomás — he can chase them |
| You see a confirmed gig you didn't know about | Tomás — sometimes new bookings come in fast |
